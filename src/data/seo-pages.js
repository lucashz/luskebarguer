export const seoLandingPages = [
  page('guias', 'Guias para cardápio digital e pedidos | TáPronto', 'Guias práticos para criar cardápio digital, divulgar sua loja e organizar pedidos de delivery, retirada e salão.', 'Guias práticos para organizar e divulgar sua loja', 'Conteúdos diretos para pequenos negócios de alimentação melhorarem cardápio, atendimento e fluxo de pedidos.', ['Criar e revisar seu cardápio digital', 'Divulgar o link e o QR Code nos canais certos', 'Organizar pedidos, adicionais, entrega e pagamento']),
